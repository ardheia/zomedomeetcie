...
**
** Created: Sat Mar 16 23:40:09 2013
...
static const char qt_meta_stringdata_GLWidget[] = {
    ...
    "setYRotation(double)\0valeurZoom\0"
    "zoom(int)\0passerEnFilaire()\0passerEnPlein()\0"
    "initialisationCommune()\0"
};
...
void GLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setXRotation((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: _t->setYRotation((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 2: _t->zoom((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->passerEnFilaire(); break;
        case 4: _t->passerEnPlein(); break;
        case 5: _t->initialisationCommune(); break;
        default: ;
        }
    }
}
